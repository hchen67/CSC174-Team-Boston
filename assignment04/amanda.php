    ...
    <div class="container">
        <nav class="menu navbar navbar-expand-lg navbar-dark bg-dark mb-4 mt-3 shadow rounded">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="amanda.php">Amanda</a></li>
...
<div class="container">
    ...
    <main class="row card-deck">
        ...
        <div class="card mx-0 shadow p-0 mb-5 bg-white rounded">
            ...
            <div class="card-body">
                <p class="card-text">In addition to my academic and curricular pursuits, I have a number of hobbies. I really enjoy dancing, and
                    ...
                    Schreckens. I like how simple excursions become adventures if you do them after midnight or in a snowstorm, and
        ...
        <div class="card mx-4 shadow p-0 mb-5 bg-white rounded">
            ...
            <div class="card-body">
                <p class="card-text">I’ve held a number of different jobs since beginning my college career. My first research job was with the
