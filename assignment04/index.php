...
<div class="row justify-content-md-center">
    <div class="card  mx-0 shadow p-3 mb-5 bg-white rounded">
        <a href="amanda.php">
            <img class="rounded fixx" src="images/amanda.jpg" alt="Amanda">
        </a>
        <div class="card-body">
    ...
    <div class="card mx-2 shadow p-3 mb-5 bg-white rounded">
        <a href="jacob.php">
            <img class="rounded fixx" src="images/wonkuk-headshot.jpg" alt="Won Kuk">
        </a>
        <div class="card-body">
    ...
    <div class="card mx-0 shadow p-3 mb-5 bg-white rounded">
        <a href="joseph.php">
            <img class="rounded fixx" src="images/jhur.jpg" alt="Joseph">
        </a>
        <div class="card-body">
